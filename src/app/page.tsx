    ...
    <div className="flex flex-col gap-32 pb-24">
      ...
      <section className="px-6 relative">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="font-sans text-brand-text-primary text-xl md:text-3xl leading-relaxed font-light">
            NACOS has given many of us more than a classroom experience.<br />
            ...
            <br />that support student growth, collaboration, and opportunity.
          </p>
        </div>
        <div className="max-w-5xl mx-auto mt-16 border border-brand-neon-green/10 rounded-[4px] p-2 bg-brand-bg-secondary">
          <img src="/photos/teaching-whiteboard.png" alt="Obioma Teaching" className="w-full aspect-video md:aspect-[21/9] object-cover rounded-[2px] opacity-80 mix-blend-luminosity hover:mix-blend-normal transition-all duration-700" />
        </div>
      </section>
      ...
      <section className="relative w-full py-32 flex items-center justify-center overflow-hidden border-y border-brand-neon-green/10">
        ...
        <div className="relative z-20 px-6 text-center">
          <h2 className="font-orbitron font-bold text-3xl md:text-5xl text-brand-text-primary max-w-4xl mx-auto leading-tight">
      ...
      <section className="px-6 text-center flex flex-col items-center justify-center">
        <NeonButton href="https://chat.whatsapp.com/ECgFFW878vr5f1ufmBPhBE" variant="whatsapp" className="text-lg px-8 py-4">
