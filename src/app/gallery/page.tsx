...
const sections: { heading: string; images: GalleryImage[] }[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/photos/gitex-agentspace.png",        title: "GITEX Agentspace",       desc: "Industry-level collaborations at GITEX global tech summit", position: "center top" },
      { src: "/photos/gitex-selfie.png",            title: "International Exposure", desc: "Seizing global opportunities at GITEX technology event" },
      { src: "/photos/gitex-sign.png",              title: "Global Representation",  desc: "Proudly representing on the global stage at GITEX" },
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/photos/selfie-conference.png",       title: "Good Vibes",              desc: "Have fun — cos why not" },
    ],
  },
];
