...
export default function Vision() {
  ...
  return (
    <div className="flex flex-col gap-32 pb-24">
      ...
      {/* Hero Statement */}
      <section className="min-h-[50vh] flex items-center justify-center px-6 border-b border-brand-neon-green/10 relative overflow-hidden bg-[radial-gradient(ellipse_at_center,rgba(0,255,102,0.05)_0%,transparent_70%)]">
        <h1 className="font-orbitron font-black text-4xl md:text-6xl text-center max-w-4xl leading-tight">
      ...
      <section className="px-6 max-w-4xl mx-auto text-center">
        <p className="font-sans text-brand-text-primary text-xl md:text-2xl leading-relaxed font-light border border-brand-neon-green/20 p-8 md:p-12 bg-brand-bg-secondary rounded-[2px] relative">
          <span className="absolute top-4 left-4 text-brand-neon-green/30 font-mono text-4xl leading-none">"</span>
          ...
          <span className="absolute bottom-[-10px] right-4 text-brand-neon-green/30 font-mono text-4xl leading-none">"</span>
        </p>
      </section>

      {/* Vision Pillars */}
      <section className="px-6 max-w-5xl mx-auto w-full">
        <div className="font-mono text-brand-neon-green text-sm opacity-70 uppercase tracking-wider mb-12 text-center">
          &lt;!-- Vision Pillars --&gt;
        </div>
